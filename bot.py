...
def solve_captcha_with_retry(sitekey, page_url, captcha_type='recaptcha', max_retries=3):
    """
    Solve CAPTCHA using integrated solver with retry logic
    """
    ...
    for attempt in range(1, max_retries + 1):
        ...
        # Use the integrated get_captcha_token solver
        ...
        try:
            ...
            if 'captcha' in text.lower() or 'recaptcha' in text.lower() or 'hcaptcha' in text.lower() or 'turnstile' in text.lower():
                ...
                if sitekey and ENABLE_CAPTCHA_SOLVING:
                    ...
                    # Solve CAPTCHA using integrated solver (synchronous call, run in thread pool)
                    ...
                    if token:
                        ...
                        headers['X-Captcha-Provider'] = 'RECAPTCHA'
...
if __name__ == '__main__':
    print("=" * 60)
    print("  AUTO SHOPIFY CHECKER BOT - WITH SELENIUMBASE CAPTCHA BYPASSING")
    print("=" * 60)
    print(f"CAPTCHA Solving: {'ENABLED' if ENABLE_CAPTCHA_SOLVING else 'DISABLED'}")
    print("Starting bot...")
